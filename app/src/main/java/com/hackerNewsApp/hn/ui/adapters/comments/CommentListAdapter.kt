...
import com.hackerNewsApp.hn.databinding.LayoutCommentBinding
import com.hackerNewsApp.hn.domain.models.CommentModel
import com.hackerNewsApp.hn.utils.AppDateTimeUtils

class CommentListAdapter : PagingDataAdapter<CommentModel,
    CommentListAdapter.CommentViewHolder>(CommentDiffUtilCallBack()) {
  ...
  fun from(parent: ViewGroup): CommentViewHolder {
    return CommentViewHolder(
      LayoutCommentBinding.inflate(LayoutInflater.from(parent.context), parent, false))
  }
