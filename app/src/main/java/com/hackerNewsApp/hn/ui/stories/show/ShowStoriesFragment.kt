...
import com.hackerNewsApp.hn.databinding.FragmentShowStoriesBinding
...
class ShowStoriesFragment : BaseFragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
    ...
    setBinding(binding)
  //  db = HackerNewsDB.getInstance(requireContext())
  ...
  override fun registerViewEvents() {
   // adapter = StoryListAdapter(this, mutableListOf(db.storyDao().getByShow("story")!!))
